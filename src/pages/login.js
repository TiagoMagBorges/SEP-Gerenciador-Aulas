    ...
    return (
        <div className={'main-background'}>
            ...
            <header className={'w-[90vw] h-[10vh] lg:w-[95vw] flex justify-between items-center text-white p-4'}>
                ...
                <Link href={'/'} className="hidden md:block content-center text-center text-white font-bold">Página
                    Inicial</Link>
            </header>
            ...
            <main className="w-[90vw] h-[89vh] lg:w-[95vw] bg-[white] rounded-[20px] mb-3 flex flex-col md:flex-row">
                ...
                {isLogin
                    ?
                    <section  className="hidden md:block w-full md:w-6/12 xl:w-8/12 h-full rounded-[15px] md:rounded-tr-[20px] md:rounded-br-[20px] bg-[#f8f8ff] p-4 text-center content-center">
                        <h1 className="text-3xl md:text-2xl font-extrabold text-[#333] font-inter">Seja bem vindo de volta!</h1>
                    </section>
                    :
